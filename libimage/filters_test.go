...
func TestFilterReference(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{[]string{"al@" + alpine.Digest().String()}, 1, []string{"quay.io/libpod/al:latest", "quay.io/libpod/al:tag"}},
		{[]string{"quay.io/libpod/al@" + alpine.Digest().String()}, 1, []string{"quay.io/libpod/al:latest", "quay.io/libpod/al:tag"}},
		...
		{[]string{"al:latest@" + alpine.Digest().String()}, 1, []string{"quay.io/libpod/al:latest", "quay.io/libpod/al:tag"}},
		{[]string{"quay.io/libpod/al:latest@" + alpine.Digest().String()}, 1, []string{"quay.io/libpod/al:latest", "quay.io/libpod/al:tag"}},
